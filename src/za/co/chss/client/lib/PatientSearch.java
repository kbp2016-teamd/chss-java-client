...
import za.co.chss.client.entities.Site;
...
public class PatientSearch {
	...
	public ArrayList<Patient> getListOfPatients(Area area)
	{
		...
		Patient p1 = new Patient("Patient1","P1Surname" , "1234567890123", "Male", 31 , "1985/01/01 ", "0812345678", site);
		Patient p2 = new Patient("Patient2","P2Surname" , "1234567890123", "Female", 34 , "1982/02/02 ", "0812345678", site);
